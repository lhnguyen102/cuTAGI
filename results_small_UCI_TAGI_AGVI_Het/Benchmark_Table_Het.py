...
for dataset in datasets:
    ...
    folder_path = os.path.join("results_small_UCI_TAGI_AGVI_Het", dataset)
...
with open("results_small_UCI_TAGI_AGVI_Het/small_UCI_regression_Het_table.txt", "w") as f:
...
plt.savefig("results_small_UCI_TAGI_AGVI_Het/small_UCI_regression_Het_table.png", bbox_inches='tight', dpi=300)
