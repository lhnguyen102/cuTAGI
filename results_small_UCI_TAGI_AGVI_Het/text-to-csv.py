...
# Read the text file
with open("results_small_UCI_TAGI_AGVI_Het/small_UCI_regression_Het_table.txt", "r") as file:
...
df.to_csv("results_small_UCI_TAGI_AGVI_Het/Benchmark_table_TAGIV.csv", index=False)
