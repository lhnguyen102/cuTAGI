...
//         var_smooths[i] =
//             var_posts[i] + tmp * (var_smooths[i + 1] - var_priors[i + 1]) *
//             tmp;
//     }
// }
...
//     // Forward pass
//     if (this->num_threads > 1) {
//         linear_fwd_mean_var_mp(this->mu_w, this->var_w, this->mu_b,
//         this->var_b,
//                                input_states.mu_a, input_states.var_a,
//                                this->input_size, this->output_size,
//                                batch_size, this->bias, this->num_threads,
//                                output_states.mu_a, output_states.var_a);
//     } else {
//         int start_chunk = 0;
//         int end_chunk = this->output_size * batch_size;
//         linear_fwd_mean_var(this->mu_w, this->var_w, this->mu_b, this->var_b,
//                             input_states.mu_a, input_states.var_a,
//                             start_chunk, end_chunk, this->input_size,
...
//                             temp_states.slinear.cov_hh,
//                             slinear_states.cov_zo);
...
//             if (this->bias) {
//                 linear_bwd_fc_delta_b(this->var_b,
