 ...
 */
{
    ...
    for (int e = 0; e < n_epochs; e++) {
        ...
        for (int i = 0; i < n_iter; i++) {
            ...
            /*std::cout << ma_output.size() << "\n";
            std::cout << y_batch.size() << "\n";
            std::cout << idx_ud_batch.size() << "\n";
            std::cout << label_batch.size() << "\n";*/
        ...
        for (int i = 0; i < test_n_iter; i++) {
            ...
            for (int j = 0; j < y_batch.size(); j++) {
                ...
                b = j / imdb.output_len;
                empirical_Sv +=
                    powf(y_batch[j] - ma_output[(b * 11) + idx_ud_batch[j]-1], 2);
                // std::cout << y_batch[j] << ":" <<ma_output[(b *
