...
void SLSTM::forget_gate(int batch_size)
/*
 */
{
...
void SLSTM::input_gate(int batch_size)
/*
 */
{
    int ni_c = this->input_size + this->output_size;
...
void SLSTM::cell_state_gate(int batch_size)
/*
 */
{
    int ni_c = this->input_size + this->output_size;
...
void SLSTM::output_gate(int batch_size)
/*
 */
{
    int ni_c = this->input_size + this->output_size;
