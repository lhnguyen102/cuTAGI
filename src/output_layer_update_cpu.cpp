...
// void compute_delta_z_output(std::vector<float> &mu_a, std::vector<float>
// &var_a,
...
//                                std::vector<float> &jcb, std::vector<float>
//                                &obs, std::vector<float> &var_v, int n,
...
//                                  std::ref(var_a), std::ref(jcb),
//                                  std::ref(obs), std::ref(var_v), start_chunk,
//                                  end_chunk, std::ref(delta_mu),
//                                  std::ref(delta_var));
//     }
...
//     std::vector<float> &delta_var)
// /*
// It computes the selected delta hidden states for output layer e.g.,
// hierarchical binary tree for classification task.
// */
// {
//     float zero_pad = 0.0f;
//     float tmp = 0.0f;
