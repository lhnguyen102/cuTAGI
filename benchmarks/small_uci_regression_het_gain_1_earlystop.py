###############################################################################
# File:         small_uci_regression_het_gain_1_earlystop.py
# Description:  Running small uci datasets with heteroscedasticity and early-stopping with both gains equal to one
...
for j in range(len(data_names)):
    ...
    if not os.path.exists("benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/{}".format(data_names[j])):
        os.makedirs("benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/{}".format(data_names[j]))
    elif os.path.isfile("benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/{}/RMSEtest.txt".format(data_names[j])) and \
        os.path.isfile("benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/{}/LLtest.txt".format(data_names[j])) and \
        os.path.isfile("benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/{}/optimal_epoch.txt".format(data_names[j])):

        os.remove("benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/{}/RMSEtest.txt".format(data_names[j]))
        os.remove("benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/{}/LLtest.txt".format(data_names[j]))
        os.remove("benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/{}/runtime_train.txt".format(data_names[j]))
        os.remove("benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/{}/optimal_epoch.txt".format(data_names[j]))
        
    # File paths for the results
    RESULTS_RMSEtest = "benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/"+data_names[j]+"/RMSEtest.txt"
    RESULTS_LLtest = "benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/"+data_names[j]+"/LLtest.txt"
    RESULTS_RUNTIME = "benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/"+data_names[j]+"/runtime_train.txt"
    RESULTS_EPOCH = "benchmarks/logs/results_small_uci_regression_het_gain_1_earlystop/"+data_names[j]+"/optimal_epoch.txt"
