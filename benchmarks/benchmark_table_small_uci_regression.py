...
for dataset in datasets:
    ...
    folder_path = os.path.join("benchmarks/logs/results_small_uci_regression", dataset)
...
with open("benchmarks/logs/results_small_uci_regression/small_uci_regression_table.txt", "w") as f:
...
plt.savefig("benchmarks/logs/results_small_uci_regression/small_uci_regression_table.png", bbox_inches='tight', dpi=300)
