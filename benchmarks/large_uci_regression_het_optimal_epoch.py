###############################################################################
# File:         large_uci_regression_het_optimal_epoch.py
...
for j in range(len(data_names)):
    ...
    if not os.path.exists("benchmarks/logs/results_large_uci_regression_het_optimal_epoch/{}".format(data_names[j])):
        os.makedirs("benchmarks/logs/results_large_uci_regression_het_optimal_epoch/{}".format(data_names[j]))
    elif os.path.isfile("benchmarks/logs/results_large_uci_regression_het_optimal_epoch/{}/RMSEtest_opt_Epoch.txt".format(data_names[j])) and \
        os.path.isfile("benchmarks/logs/results_large_uci_regression_het_optimal_epoch/{}/LLtest_opt_Epoch.txt".format(data_names[j])) and \
        os.path.isfile("benchmarks/logs/results_large_uci_regression_het_optimal_epoch/{}/runtime_train_opt_Epoch.txt".format(data_names[j])):

        os.remove("benchmarks/logs/results_large_uci_regression_het_optimal_epoch/{}/RMSEtest_opt_Epoch.txt".format(data_names[j]))
        os.remove("benchmarks/logs/results_large_uci_regression_het_optimal_epoch/{}/LLtest_opt_Epoch.txt".format(data_names[j]))
        os.remove("benchmarks/logs/results_large_uci_regression_het_optimal_epoch/{}/runtime_train_opt_Epoch.txt".format(data_names[j]))


    # File paths for the results
    RESULTS_RMSEtest = "benchmarks/logs/results_large_uci_regression_het_optimal_epoch/"+data_names[j]+"/RMSEtest_opt_Epoch.txt"
    RESULTS_LLtest = "benchmarks/logs/results_large_uci_regression_het_optimal_epoch/"+data_names[j]+"/LLtest_opt_Epoch.txt"
    RESULTS_RUNTIME = "benchmarks/logs/results_large_uci_regression_het_optimal_epoch/"+data_names[j]+"/runtime_train_opt_Epoch.txt"
