###############################################################################
# File:         small_uci_regression_het_optimal_epoch.py
# Description:  Running small uci datasets with heteroscedasticity for average optimal epoch in each split
...
for j in range(len(data_names)):
    ...
    if not os.path.exists("benchmarks/logs/results_small_uci_regression_het_optimal_epoch/{}".format(data_names[j])):
        os.makedirs("benchmarks/logs/results_small_uci_regression_het_optimal_epoch/{}".format(data_names[j]))
    elif os.path.isfile("benchmarks/logs/results_small_uci_regression_het_optimal_epoch/{}/RMSEtest_opt_Epoch.txt".format(data_names[j])) and \
        os.path.isfile("benchmarks/logs/results_small_uci_regression_het_optimal_epoch/{}/LLtest_opt_Epoch.txt".format(data_names[j])) and \
        os.path.isfile("benchmarks/logs/results_small_uci_regression_het_optimal_epoch/{}/runtime_train_opt_Epoch.txt".format(data_names[j])):

        os.remove("benchmarks/logs/results_small_uci_regression_het_optimal_epoch/{}/RMSEtest_opt_Epoch.txt".format(data_names[j]))
        os.remove("benchmarks/logs/results_small_uci_regression_het_optimal_epoch/{}/LLtest_opt_Epoch.txt".format(data_names[j]))
        os.remove("benchmarks/logs/results_small_uci_regression_het_optimal_epoch/{}/runtime_train_opt_Epoch.txt".format(data_names[j]))


    # File paths for the results
    RESULTS_RMSEtest = "benchmarks/logs/results_small_uci_regression_het_optimal_epoch/"+data_names[j]+"/RMSEtest_opt_Epoch.txt"
    RESULTS_LLtest = "benchmarks/logs/results_small_uci_regression_het_optimal_epoch/"+data_names[j]+"/LLtest_opt_Epoch.txt"
    RESULTS_RUNTIME = "benchmarks/logs/results_small_uci_regression_het_optimal_epoch/"+data_names[j]+"/runtime_train_opt_Epoch.txt"
    ...
    # Gain values for each dataset as provided in Table D.1 of the Supplementary material
    ...
    filepath_opt_epoch = "benchmarks/logs/results_small_uci_regression_het_earlystop/"+data_names[j]+"/optimal_epoch.txt"
