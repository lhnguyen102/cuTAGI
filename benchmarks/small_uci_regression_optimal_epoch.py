###############################################################################
# File:         small_uci_regression_optimal_epoch.py
# Description:  Running small uci datasets until the optimal epoch
...
# define the number of runs where each run is with a different random seed
total_run = 5
