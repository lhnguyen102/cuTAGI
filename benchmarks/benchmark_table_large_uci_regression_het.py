...
for dataset in datasets:
    ...
    folder_path = os.path.join("benchmarks/logs/results_large_uci_regression_het_optimal_epoch", dataset)
...
with open("benchmarks/logs/results_large_uci_regression_het_optimal_epoch/large_uci_regression_het_table.txt", "w") as f:
