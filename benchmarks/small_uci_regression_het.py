###############################################################################
# File:         small_uci_regression_het.py
# Description:  Running small uci datasets with heteroscedasticity for user-defined epochs
...
for j in range(len(data_names)):
    ...
    if not os.path.exists("benchmarks/logs/results_small_uci_regression_het/{}".format(data_names[j])):
        os.makedirs("benchmarks/logs/results_small_uci_regression_het/{}".format(data_names[j]))
    elif os.path.isfile("benchmarks/logs/results_small_uci_regression_het/{}/RMSEtest.txt".format(data_names[j])) and \
        os.path.isfile("benchmarks/logs/results_small_uci_regression_het/{}/LLtest.txt".format(data_names[j])) and \
        os.path.isfile("benchmarks/logs/results_small_uci_regression_het/{}/runtime_train.txt".format(data_names[j])):

        os.remove("benchmarks/logs/results_small_uci_regression_het/{}/RMSEtest.txt".format(data_names[j]))
        os.remove("benchmarks/logs/results_small_uci_regression_het/{}/LLtest.txt".format(data_names[j]))
        os.remove("benchmarks/logs/results_small_uci_regression_het/{}/runtime_train.txt".format(data_names[j]))


    # File paths for the results
    RESULTS_RMSEtest = "benchmarks/logs/results_small_uci_regression_het/"+data_names[j]+"/RMSEtest.txt"
    RESULTS_LLtest = "benchmarks/logs/results_small_uci_regression_het/"+data_names[j]+"/LLtest.txt"
    RESULTS_RUNTIME = "benchmarks/logs/results_small_uci_regression_het/"+data_names[j]+"/runtime_train.txt"
    ...
    plt.savefig("benchmarks/logs/results_small_uci_regression_het/"+data_names[j]+"/RMSE_LL.png")
