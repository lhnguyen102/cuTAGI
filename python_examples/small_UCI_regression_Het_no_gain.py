...
for j in range(len(data_names)):
    ...
    elif os.path.isfile("results_small_UCI_TAGI_AGVI_Het_NoGain/{}/RMSEtest.txt".format(data_names[j])) and \
        os.path.isfile("results_small_UCI_TAGI_AGVI_Het_NoGain/{}/LLtest.txt".format(data_names[j])) and \
        os.path.isfile("results_small_UCI_TAGI_AGVI_Het_NoGain/{}/runtime_train.txt".format(data_names[j])):

        os.remove("results_small_UCI_TAGI_AGVI_Het_NoGain/{}/RMSEtest.txt".format(data_names[j]))
        os.remove("results_small_UCI_TAGI_AGVI_Het_NoGain/{}/LLtest.txt".format(data_names[j]))
    ...
    if use_optimal_epoch != 1:
        ...
        plt.savefig("results_small_UCI_TAGI_AGVI_Het_NoGain/" + data_names[j] + "/RMSE_LL.png")
