...
for j in range(len(data_names)):
    ...
    if not os.path.exists("results_large_UCI_TAGI_AGVI_Het_earlystop/{}".format(data_names[j])):
        os.makedirs("results_large_UCI_TAGI_AGVI_Het_earlystop/{}".format(data_names[j]))
    elif os.path.isfile("results_large_UCI_TAGI_AGVI_Het_earlystop/{}/RMSEtest.txt".format(data_names[j])) and \
        os.path.isfile("results_large_UCI_TAGI_AGVI_Het_earlystop/{}/LLtest.txt".format(data_names[j])) and \
        os.path.isfile("results_large_UCI_TAGI_AGVI_Het_earlystop/{}/optimal_epoch.txt".format(data_names[j])):

        os.remove("results_large_UCI_TAGI_AGVI_Het_earlystop/{}/RMSEtest.txt".format(data_names[j]))
        os.remove("results_large_UCI_TAGI_AGVI_Het_earlystop/{}/LLtest.txt".format(data_names[j]))
        os.remove("results_large_UCI_TAGI_AGVI_Het_earlystop/{}/runtime_train.txt".format(data_names[j]))
        os.remove("results_large_UCI_TAGI_AGVI_Het_earlystop/{}/optimal_epoch.txt".format(data_names[j]))

    # File paths for the results
    RESULTS_RMSEtest = "results_large_UCI_TAGI_AGVI_Het_earlystop/"+data_names[j]+"/RMSEtest.txt"
    RESULTS_LLtest = "results_large_UCI_TAGI_AGVI_Het_earlystop/"+data_names[j]+"/LLtest.txt"
    RESULTS_RUNTIME = "results_large_UCI_TAGI_AGVI_Het_earlystop/"+data_names[j]+"/runtime_train.txt"
    RESULTS_EPOCH = "results_large_UCI_TAGI_AGVI_Het_earlystop/"+data_names[j]+"/optimal_epoch.txt"
