...
for j in range(len(data_names)):
    ...
    # elif os.path.isfile("results_large_UCI_TAGI_AGVI_Het/{}/RMSEtest_opt_Epoch.txt".format(data_names[j])) and \
    #     os.path.isfile("results_large_UCI_TAGI_AGVI_Het/{}/LLtest_opt_Epoch.txt".format(data_names[j])) and \
    #     os.path.isfile("results_large_UCI_TAGI_AGVI_Het/{}/runtime_train_opt_Epoch.txt".format(data_names[j])):

    #     os.remove("results_large_UCI_TAGI_AGVI_Het/{}/RMSEtest_opt_Epoch.txt".format(data_names[j]))
    #     os.remove("results_large_UCI_TAGI_AGVI_Het/{}/LLtest_opt_Epoch.txt".format(data_names[j]))
    #     os.remove("results_large_UCI_TAGI_AGVI_Het/{}/runtime_train_opt_Epoch.txt".format(data_names[j]))


    # File paths for the results
    RESULTS_RMSEtest = "results_large_UCI_TAGI_AGVI_Het/"+data_names[j]+"/RMSEtest_opt_Epoch_B_100.txt"
    RESULTS_LLtest = "results_large_UCI_TAGI_AGVI_Het/"+data_names[j]+"/LLtest_opt_Epoch_B_100.txt"
    RESULTS_RUNTIME = "results_large_UCI_TAGI_AGVI_Het/"+data_names[j]+"/runtime_train_opt_Epoch_B_100.txt"
