...
for j in range(len(data_names)):
    ...
    elif os.path.isfile("results_small_UCI_TAGI_AGVI_Het_NoGain/{}/RMSEtest_opt_Epoch.txt".format(data_names[j])) and \
        os.path.isfile("results_small_UCI_TAGI_AGVI_Het_NoGain/{}/LLtest_opt_Epoch.txt".format(data_names[j])) and \
        os.path.isfile("results_small_UCI_TAGI_AGVI_Het_NoGain/{}/runtime_train_opt_Epoch.txt".format(data_names[j])):
