...
for j in range(len(data_names)):
    ...
    if not os.path.exists("results_small_UCI_TAGI_AGVI_Het_earlystop/{}".format(data_names[j])):
    ...
    RESULTS_RMSEtest = "results_small_UCI_TAGI_AGVI_Het_earlystop/"+data_names[j]+"/RMSEtest.txt"
    RESULTS_LLtest = "results_small_UCI_TAGI_AGVI_Het_earlystop/"+data_names[j]+"/LLtest.txt"
    RESULTS_RUNTIME = "results_small_UCI_TAGI_AGVI_Het_earlystop/"+data_names[j]+"/runtime_train.txt"
    RESULTS_EPOCH = "results_small_UCI_TAGI_AGVI_Het_earlystop/"+data_names[j]+"/optimal_epoch.txt"
