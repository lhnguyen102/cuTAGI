...
#include "test_cnn_batch_norm.cuh"
...
const std::vector<int> FILTERS = {1, 16, 16, 16, 32, 32, 32, 1, 1};
const std::vector<int> PADS = {1, 0, 0, 0, 0, 0, 0, 0, 0};
const std::vector<int> PAD_TYPES = {1, 0, 0, 0, 0, 0, 0, 0, 0};
const std::vector<int> ACTIVATIONS = {0, 4, 0, 0, 4, 0, 0, 4, 1};
 ...
 *
 */
bool test_cnn_batch_norm(bool recompute_outputs, std::string date,
