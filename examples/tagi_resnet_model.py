...
from pytagi.nn import (AvgPool2d, BatchNorm2d, Conv2d, LayerBlock, Linear,
                       MixtureReLU, ReLU, ResNetBlock, Sequential)
...
def resnet18_imagenet(
    ...
    final_layers = [
        AvgPool2d(7),
        Linear(512, nb_outputs, gain_weight=gain_w, gain_bias=gain_b, bias=True),
    ]
